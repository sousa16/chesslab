// Chess move sound - simple beep using Web Audio API
...
export function playCorrectSound() {
  try {
    ...
    // Play two notes in succession for a pleasant "correct" sound
...
export function playIncorrectSound() {
  try {
    ...
    oscillator.frequency.value = 200; // Low note for incorrect
